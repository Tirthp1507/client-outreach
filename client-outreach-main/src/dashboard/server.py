...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .demo-frame-container.mobile-mode {
      padding: 12px 0;
    }
    .demo-frame {
      width: 100%;
...
<body>
            ...
            <div class="card">
              ...
              <div>
                <div class="demo-toolbar">
                  <div class="form-label" style="margin-bottom:0;">Interactive Commercial Website Demo</div>
                  <div style="display:flex;gap:6px;align-items:center;">
                    <div class="demo-device-btns">
                      <button type="button" class="demo-device-btn active" onclick="setDemoView('desktop', this)">🖥️ Desktop</button>
                      <button type="button" class="demo-device-btn" onclick="setDemoView('tablet', this)">💻 Tablet</button>
                      <button type="button" class="demo-device-btn" onclick="setDemoView('mobile', this)">📱 Mobile</button>
                    </div>
                    <button type="button" class="btn btn-outline" style="padding:2px 8px;font-size:11px;" onclick="reloadDemoFrame()" title="Reload Frame">🔄</button>
                    <a id="open-demo-btn" href="#" target="_blank" class="btn btn-outline" style="padding:2px 8px;font-size:11px;">Open Full Tab ↗</a>
                  </div>
                </div>
                <div class="demo-frame-container" id="demo-frame-wrapper">
  ...
  <script>
    ...
    function setDemoView(mode, btn) {
      document.querySelectorAll('.demo-device-btn').forEach(b => b.classList.remove('active'));
      if (btn) btn.classList.add('active');
      const frame = document.getElementById('demo-iframe');
      const wrapper = document.getElementById('demo-frame-wrapper');
      ...
      if (mode === 'mobile') {
        ...
        frame.classList.add('view-tablet');
