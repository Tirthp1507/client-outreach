...
class ContactRecord(BaseModel):
    """Legitimately discovered public business contact point with provenance & verification."""
    id: str
    business_id: str
    email: Optional[str] = None
    ...
    source_type: ContactSourceType = ContactSourceType.WEBSITE_CONTACT
    confidence: ContactConfidence = ContactConfidence.MEDIUM
    verification_status: EmailVerificationStatus = EmailVerificationStatus.UNVERIFIED
